        ...
        mAuthListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if (user!=null){
                    ...
                    Intent moveToHome = new Intent(Regis.this,PopotoanHome.class);
        ...
        if(!TextUtils.isEmpty(emailUser) && !TextUtils.isEmpty(passUser)){
            ...
            mAuth.createUserWithEmailAndPassword(emailUser,passUser).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                ...
                public void onComplete(@NonNull Task<AuthResult> task) {
                    ...
                    {
                        Toast.makeText(Regis.this,"Account Created Success",Toast.LENGTH_LONG).show();
                        ...
                        Toast.makeText(Regis.this,"Account Created Failed",Toast.LENGTH_LONG).show();
                        //dismiss progress dialog
                        mProgressDialog.dismiss();
                    }
